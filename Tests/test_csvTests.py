...
class CalculatorCsvTest(unittest.TestCase):
    ...
    def test_csvReader_addition(self):
        self.csv_reader = CsvReader('/Tests/Data(CSV)/addition.csv')
